...
# ASCII ART DIARYYY, Due __Tuesday 10/16 by 11PM__
...
* go back and modify the tag links in your template for `/` so each has an appropriate link to filter the artworks WITHOUT having to submit a form
